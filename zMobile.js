...
(function() {
    ...
    var getPageLeft = CalculateElementDocumentOffset("offsetLeft"),
    ...
    var onSwipeStartH = SwipeStart(true),
    ...
    function SlideListPanel(parent, arg) {
        ...
        function doWhenItem2(targetPos) {
            ...
            var showBlankLi = ul.children[targetPos > 0 ? 0 : 2],
