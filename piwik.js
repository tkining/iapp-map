...
if (typeof Piwik !== "object") {
    Piwik = (function() {
        var i, a = {},
            ...
            F = screen,
            C = window,
            f = C.performance || C.mozPerformance || C.msPerformance || C.webkitPerformance,
            n = false,
            A = [],
            k = C.encodeURIComponent,
        ...
        function z(ap, aS) {
            var W = I(s.domain, C.location.href, v()),
                bd = w(W[0]),
                bs = W[1],
                a0 = W[2],
                bt = false,
                aW = "GET",
                aY = aW,
                aK = "application/x-www-form-urlencoded; charset=UTF-8",
                au = aK,
                U = ap || "",
                am = "",
                aU = "",
                bi = aS || "",
                aI, ay = s.title,
                aA = "7z|aac|apk|ar[cj]|as[fx]|avi|azw3|bin|csv|deb|dmg|docx?|epub|exe|flv|gif|gz|gzip|hqx|jar|jpe?g|js|mobi|mp(2|3|4|e?g)|mov(ie)?|ms[ip]|od[bfgpst]|og[gv]|pdf|phps|png|pptx?|qtm?|ra[mr]?|rpm|sea|sit|tar|t?bz2?|tgz|torrent|txt|wav|wm[av]|wpd||xlsx?|xml|z|zip",
                aV = [bd],
                Z = [],
                aN = [],
                ao = [],
                aT = 500,
                aa, aq, ab, ad, aC = ["pk_campaign", "piwik_campaign", "utm_campaign", "utm_source", "utm_medium"],
                ax = ["pk_kwd", "piwik_kwd", "utm_term"],
                bq = "_pk_",
                ag, br, ae = false,
                bl, aE, aH, al = 63072000000,
                an = 1800000,
                aJ = 15768000000,
                aF = true,
                at = 0,
            ...
            function az(by, bW, bX, bz) {
                var bU, bx = new Date(),
                    bG = Math.round(bx.getTime() / 1000),
                    b0, bV, bB, bM, bR, bF, bP, bC, bT, bA = 1024,
                    b2, bJ, bQ = Y,
                    bH = a7("ses"),
                    bI = a7("ref"),
                    b3 = a7("cvar"),
            ...
            function aM(bz, bA) {
                var bw = new Date(),
                    by = az("action_name=" + k(P(bz || ay)), bA, "log");
                aD(by, aT);
                if (aa && aq && !a1) {
                    a1 = true;
                    O(s, "click", bh);
            ...
            function a5(bB) {
                ...
                if (u(bB.href)) {
                    var bC = bB.hostname || b(bB.href),
                        bD = bC.toLowerCase(),
                        by = bB.href.replace(bC, bD),
                        bA = new RegExp("^(javascript|vbscript|jscript|mocha|livescript|ecmascript|mailto):", "i");
                    if (!bA.test(by)) {
